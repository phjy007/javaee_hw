...
public class updateExperimentServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String updateNewExperiment = "UPDATE javaee_pj_experiment SET " + 
			"expname=\"" + expname + "\"" + "," +
			...
			" WHERE id=" + exp_id_s;
		System.out.println(updateNewExperiment);
		SqlConn sqlconn = new SqlConn();
		sqlconn.executeInsert(updateNewExperiment);
		response.sendRedirect("./refreshExperiment?page=1");
	}
