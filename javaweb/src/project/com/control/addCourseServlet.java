...
public class addCourseServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String teacher_id_s = (String)request.getParameter("course_teacher_id");
		teacher_id_s = new String(teacher_id_s.getBytes("iso-8859-1"), "gb2312");
		Integer teacher_id = Integer.parseInt(teacher_id_s);
		...
		response.sendRedirect("./showCourse.jsp?page=1");
	}
